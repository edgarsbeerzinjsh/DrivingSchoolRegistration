...
export const inputFieldErrors = (inputData: InputForm, validationErrors: InputErrors): InputForm => {
    return {
        firstName: { 
            value: inputData.firstName.value, 
            error: validationErrors.firstName 
        },
        lastName: { 
            value: inputData.lastName.value, 
            error: validationErrors.lastName 
        },
        yearOfBirth: { 
            value: inputData.yearOfBirth.value,
        ...
        mobilePhone: { 
            value: inputData.mobilePhone.value, 
        ...
        trainingCategory: { 
            value: inputData.trainingCategory.value, 
            error: validationErrors.trainingCategory 
        },
        examTime: { 
            value: inputData.examTime.value, 
